...
with col12:
    ...
    st.write('En el caso de la cantidad de sulfato el agua potable muestra mayor dispersiOn, mostrando también una asimetría positiva, aunque tanto esta como el agua no potable tienen medianas similares.')
...
with col13:
    ...
    st.write('En la conductividad el agua no potable muestra una ligera asimetría positiva, ambas dispersiones se sitúan entre los 380 y 490 aproximadamente y sOlo en el caso del agua no potable se evidencian outliers en los dos límites.')
with col14:
